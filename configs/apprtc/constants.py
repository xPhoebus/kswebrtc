...
TURN_BASE_URL = 'https://' + apprtclocal.HOST_NAME + ':1443'
...
WSS_INSTANCES = [{
    WSS_INSTANCE_HOST_KEY: apprtclocal.HOST_NAME + ':' + apprtclocal.WEBSOCKET_PORT,
    WSS_INSTANCE_NAME_KEY: 'wsserver-std',
    WSS_INSTANCE_ZONE_KEY: 'us-central1-a'
}, {
    WSS_INSTANCE_HOST_KEY: apprtclocal.HOST_IP + ':' + apprtclocal.WEBSOCKET_PORT,
    WSS_INSTANCE_NAME_KEY: 'wsserver-std-2',
    WSS_INSTANCE_ZONE_KEY: 'us-central1-f'
}, {
    WSS_INSTANCE_HOST_KEY: '127.0.0.1:' + apprtclocal.WEBSOCKET_PORT,
    WSS_INSTANCE_NAME_KEY: 'wsserver-std-2',
    WSS_INSTANCE_ZONE_KEY: 'us-central1-f'
}]
